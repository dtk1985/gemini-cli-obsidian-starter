...
# Auto-detect vault path from script location (.gemini/skills-src/granola/scripts/granola.py)
VAULT_PATH = Path(__file__).resolve().parents[4]
MEETINGS_FOLDER = VAULT_PATH / "Meetings"
# Template is in ../assets/granola-meeting.md relative to this script
TEMPLATE_PATH = Path(__file__).parent.parent / "assets/granola-meeting.md"
